...
- [ ] 사물 명사는 거의 예외 없이 셀 수 있다는 것을 안다
- [ ] "덩어리 vs 종류"라는 기준을 한 문장으로 설명할 수 있다
...
flowchart TD
    A[명사를 만났다] --> B{사물인가?}
    B -->|Yes| C[거의 무조건 가산<br>a house, a book]
    B -->|No| D{덩어리/개념인가?<br>vs 종류/구체적 경험인가?}
    D -->|덩어리/개념| E[불가산<br>food, experience, effort]
    D -->|종류/구체적| F[가산<br>foods, experiences, an effort]

    G[암기 필수 명사] --> H[무조건 불가산]
    H --> I[weather, progress,<br>permission, stuff]
    G --> J[가산/불가산 전환]
    J --> K[food, hair, experience,<br>effort, difficulty]
```
...
- [ ] "food"를 사용한 문장 3개 작성 (불가산 2개, 가산 1개)
- [ ] "experience"를 사용한 문장 3개 작성 (불가산 2개, 가산 1개)
- [ ] "effort", "difficulty" 각각 불가산/가산 예문 1개씩 작성
- [ ] 실제 대화에서 위 단어들을 올바르게 1회 이상 사용해보기
