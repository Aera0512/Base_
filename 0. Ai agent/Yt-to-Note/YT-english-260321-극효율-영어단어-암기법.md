...
- [ ] 표현, 문법, 발음 영역의 차이를 설명할 수 있다
- [ ] 표현 영역이 가장 중요한 이유 3가지를 말할 수 있다
- [ ] "귀가 뚫린다"는 말이 왜 거짓인지 설명할 수 있다
...
- [ ] 표현 학습의 유일한 정답을 말할 수 있다
- [ ] 반복이 왜 장기 기억에 중요한지 뇌과학적으로 설명할 수 있다
- [ ] 학습자가 스스로에게 해야 할 올바른 질문이 무엇인지 안다
...
- [ ] 광역 학습의 정의를 설명할 수 있다
- [ ] 뱃살 비유를 통해 광역 학습의 원리를 남에게 설명할 수 있다
- [ ] 단어장의 적절한 비중(20~30%)을 기억하고 있다
- [ ] 단어장 vs 광역 학습의 차이를 표로 그릴 수 있다
...
**기존 지식과의 연결**:
- [[YT-knowledge-260310-토리파-공부법-종합|토리파 공부법 종합]] — 간격 반복(1/4/7/14/30)과 빠른 반복 원칙. 이 영상의 "반복이 핵심"과 일맥상통
