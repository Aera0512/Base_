...
flowchart TD
    ...
    G --> J[If + 과거형<br/>would + 원형]
    H --> K[If + had p.p.<br/>would have p.p.]
    I --> L[If + had p.p.<br/>would + 원형 + now]
```
...
### 연결 노트
- [[YT-english-260310-수동태-완전정복|수동태 완전정복]] - 함께 학습하면 좋은 영문법 노트
