...
> | 영역 | 성격 | 시간 | 기준 |
> |---|---|---|---|
> | S1 | 수동적 지식 × 집중학습 | 41분 | S1 30% × 집중 70% |
> | S1 | 수동적 지식 × 광역학습 | 17분 | S1 30% × 광역 30% |
> | 토익 | 수동적 지식 × 집중학습 | 54분 | 토익 40% × 집중 70% |
> | 토익 | 수동적 지식 × 광역학습 | 23분 | 토익 40% × 광역 30% |
> | 영어 표현 드릴 | 수동적 지식 × 집중학습 | 40분 | 드릴 30% × 집중 70% |
> | 영어 표현 드릴 | 수동적 지식 × 광역학습 | 17분 | 드릴 30% × 광역 30% |
> | **합계** | | **3시간 12분** | |
>
> ### 능동적 지식 (48분)
> | 구분 | 성격 | 시간 | 기준 |
...
> | 영역 | 성격 | 시간 | 기준 |
> |---|---|---|---|
> | S1 | 수동적 지식 × 집중학습 | 1시간 | S1 30% × 집중 70% |
> | S1 | 수동적 지식 × 광역학습 | 26분 | S1 30% × 광역 30% |
> | 토익 | 수동적 지식 × 집중학습 | 1시간 21분 | 토익 40% × 집중 70% |
> | 토익 | 수동적 지식 × 광역학습 | 34분 | 토익 40% × 광역 30% |
> | 영어 표현 드릴 | 수동적 지식 × 집중학습 | 1시간 1분 | 드릴 30% × 집중 70% |
> | 영어 표현 드릴 | 수동적 지식 × 광역학습 | 26분 | 드릴 30% × 광역 30% |
> | **합계** | | **4시간 48분** | |
>
> ### 능동적 지식 (1시간 12분)
> | 구분 | 성격 | 시간 | 기준 |
...
> | 영역 | 성격 | 시간 | 기준 |
> |---|---|---|---|
> | S1 | 수동적 지식 × 집중학습 | 1시간 21분 | S1 30% × 집중 70% |
> | S1 | 수동적 지식 × 광역학습 | 34분 | S1 30% × 광역 30% |
> | 토익 | 수동적 지식 × 집중학습 | 1시간 48분 | 토익 40% × 집중 70% |
> | 토익 | 수동적 지식 × 광역학습 | 46분 | 토익 40% × 광역 30% |
> | 영어 표현 드릴 | 수동적 지식 × 집중학습 | 1시간 21분 | 드릴 30% × 집중 70% |
> | 영어 표현 드릴 | 수동적 지식 × 광역학습 | 34분 | 드릴 30% × 광역 30% |
> | **합계** | | **6시간 24분** | |
>
> ### 능동적 지식 (1시간 36분)
> | 구분 | 성격 | 시간 | 기준 |
