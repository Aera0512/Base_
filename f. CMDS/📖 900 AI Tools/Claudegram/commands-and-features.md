...
> [!tip] 멀티 세션 활용
> 여러 프로젝트를 동시에 관리하는 방법은 [[workflows#워크플로우 4 멀티 세션 프로젝트 관리|활용 워크플로우]]를 참고하세요.
...
> [!info] 연동 상세
> 각 연동 서비스의 상세 설정과 동작 방식은 [[integrations|외부 연동]] 노트를 참고하세요.
...
> [!tip] 음성 워크플로우
> 핸즈프리 사용 방법은 [[workflows#워크플로우 3 음성 기반 상호작용|활용 워크플로우]]에서 확인하세요.
...
> [!tip] 실전 활용
> 이 명령어들을 조합한 실전 워크플로우는 [[workflows|활용 워크플로우]] 노트를 참고하세요.

---

## 관련 노트
- [[index|Claudegram 개요]] — 프로젝트 소개
- [[integrations|외부 연동]] — 명령어가 사용하는 연동 서비스
- [[architecture|아키텍처]] — 명령어를 구현하는 코드 구조
- [[workflows|활용 워크플로우]] — 명령어 조합 활용법
