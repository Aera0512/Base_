...
> [!tip] 자세한 기술 구조
> 코드 구조와 모듈 설명은 [[architecture|아키텍처]] 노트를 참고하세요.
...
> [!info] 전체 명령어 목록
> [[commands-and-features|명령어 및 기능]] 노트에서 모든 명령어를 확인할 수 있습니다.
...
## 관련 노트
- [[setup-and-config|설치 및 설정]] — 환경 구성 및 첫 실행
- [[architecture|아키텍처]] — 코드 구조 및 기술 설계
- [[commands-and-features|명령어 및 기능]] — 전체 명령어 레퍼런스
- [[integrations|외부 연동]] — Reddit, Medium, 음성 등 연동
- [[workflows|활용 워크플로우]] — 실전 활용 가이드
