...
> [!tip] 연동 상세 설정
> 각 연동 서비스의 자세한 설정은 [[integrations|외부 연동]] 노트를 참고하세요.
...
> [!tip] 자체 편집 워크플로우
> Claudegram이 자기 자신의 코드를 편집하는 워크플로우는 [[workflows#워크플로우 5 자체 편집 Claudegram이 스스로 코드 수정|활용 워크플로우]]에서 확인하세요.
...
> [!info] 아키텍처의 보안 모델
> 코드 수준의 보안 설계는 [[architecture#보안 모델|아키텍처]] 노트를 참고하세요.

---

## 관련 노트
- [[index|Claudegram 개요]] — 프로젝트 소개
- [[commands-and-features|명령어 및 기능]] — 설정 후 사용 가능한 명령어
- [[integrations|외부 연동]] — 연동 서비스별 상세 설정
- [[architecture|아키텍처]] — 코드 구조 및 보안 모델
