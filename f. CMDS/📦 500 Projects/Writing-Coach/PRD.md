...
- 에세이 권장 길이: 200-350 단어 (학습 효과 최적 구간). 최대 500 단어까지 허용. Cowork 세션의 컨텍스트(200K 토큰)에서 3라운드 + 리라이트가 충분히 수용 가능
...
- 목표 단어 수 제안: 기본 250-350 단어 (사용자 조절 가능, 최대 500 단어)
...
단, 컨텍스트 절약을 위해 이전 라운드의 피드백은 요약(1-2줄)만 유지하고, 오류 프로필과 세션 기록은 Obsidian에 저장하여 세션 간 영속성을 보장한다.
