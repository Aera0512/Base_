...
```mermaid
mindmap
  root((전치사 Preposition))
    기본 개념
      두 독립체의 관계를 연결
      명사 앞에 위치 → 前置
      부사와 혼동 주의
        check it out → out은 부사
    전치사 ≠ 한국어 조사
      겹치는 부분 존재
      안 겹치는 부분이 더 많음
    종류
      단순 전치사
        in, on, at, off, to, for, as
      복합 전치사
        in front of, out of, along with
...
- [ ] [[나머지/도구와 자동화/AI Agent/Yt-to-Note/YT-english-260305-전치사-접근법-심화-2편]] 에서 개별 전치사의 심화 뉘앙스 학습 예정.
...
| 자료 | 유형 | 왜 읽어야 하는지 |
|------|------|-----------------|
| [[나머지/도구와 자동화/AI Agent/Yt-to-Note/YT-english-260305-전치사-접근법-심화-2편]] | 후속 영상 | 2편: 공간→시간→추상 발달 공식과 전치사 공부법 |
| [[나머지/도구와 자동화/CMDS/00. Inbox/영어 발음기호 IPA 개념 교과서]] | 볼트 노트 | 전치사 발음(at /æt/, in /ɪn/, on /ɒn/) 정확히 익히기 |
...
inside가 물리적 공간에만 쓰인다는 규칙은 [[나머지/도구와 자동화/CMDS/00. Inbox/영어 발음기호 IPA 개념 교과서]]에서 다룬 음소 체계 학습과 비슷한 구조다 — 표면적으로 같아 보이지만(in ≈ inside, 비슷한 발음) 내부적으로 적용 범위가 전혀 다르다는 점에서. 언어의 규칙은 형태보다 **기능과 범위**로 이해해야 한다는 원칙이 반복된다.

2편에서 다룰 개별 전치사의 심화 뉘앙스([[나머지/도구와 자동화/AI Agent/Yt-to-Note/YT-english-260305-전치사-접근법-심화-2편]])가 기대된다. 1편의 큰 그림(관계, 범위, 혼동 쌍)이 2편의 세부 뉘앙스 학습의 기반이 될 것이다.