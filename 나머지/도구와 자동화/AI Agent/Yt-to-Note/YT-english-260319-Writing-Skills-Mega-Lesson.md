...
```mermaid
flowchart LR
    A[Purpose 파악] --> B[Audience 분석]
    B --> C[Outline 작성]
    C --> D[초고 작성]
    D --> E[Sentence Variety 확인]
    E --> F[Proofread Forward]
    F --> G[Proofread Backward]
    G --> H[피드백 반영]
    H --> I[최종본]
```
...
**기존 지식과의 연결:**
- [[나머지/도구와 자동화/AI Agent/Yt-to-Note/YT-english-260305-전치사-접근법-기초-1편]] — 전치사 선택의 원리와 연결
- [[나머지/도구와 자동화/AI Agent/Yt-to-Note/YT-english-260312-Global-Warming-Essay-Writing]] — Academic writing 실전 적용
