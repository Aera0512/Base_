...
**모두 해당하지 않는다면** → **[[나머지/도구와 자동화/CMDS/📖 400 Methodologies/AI 소형 프로젝트 빠른 가이드 (pipeline-quick)]]** 사용
...
CLAUDE.md 범용 템플릿이 필요하면 → **[[나머지/시스템/템플릿/CLAUDE-template]]** 참고
...
- 소형 프로젝트 가이드: **[[나머지/도구와 자동화/CMDS/📖 400 Methodologies/AI 소형 프로젝트 빠른 가이드 (pipeline-quick)]]**
