...
> [!info] 핸즈프리 워크플로우
> 음성 입력과 TTS 출력을 결합한 핸즈프리 워크플로우는 [[나머지/도구와 자동화/CMDS/📖 900 AI Tools/Claudegram/workflows#워크플로우 3 음성 기반 상호작용|활용 워크플로우]]를 참고하세요.
...
- [[나머지/도구와 자동화/CMDS/📖 900 AI Tools/Claudegram/setup-and-config|설치 및 설정]] — 연동별 환경 변수 설정
- [[나머지/도구와 자동화/CMDS/📖 900 AI Tools/Claudegram/commands-and-features|명령어 및 기능]] — 연동 관련 명령어
- [[나머지/도구와 자동화/CMDS/📖 900 AI Tools/Claudegram/workflows|활용 워크플로우]] — 연동을 활용한 실전 워크플로우
