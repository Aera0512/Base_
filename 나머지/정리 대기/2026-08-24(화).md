...
# Invalid date · undefined요일

> [!nav] 네비게이션
> **[[Invalid date|Invalid date]]** · **[[Invalid date|Invalid date]]** · **[[Invalid date|Invalid date주차]]**
>
> ◀ [[Invalid date|어제]] · **오늘** · [[Invalid date|내일]] ▶
...
LIST
FROM ""
WHERE file.cday = date("Invalid date")
...
LIST
FROM ""
WHERE file.mday = date("Invalid date") AND file.cday != date("Invalid date")
